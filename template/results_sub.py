			...
			<div id="header-gradient">
				...
				<div id="header-position">
					...
					<form>
						...
						<a href="#" id="manage" class="button-top">Manage Ticket</a>
...
if conn.is_connected():
   ...
   if radio==" 1 ":
      ...
      print("""
				...
				<H2 style="margin-top:100px;margin-left:20px;">Chose your seats</H2>
      ...
      st_date = datetime.datetime.strptime(end_date, ' %m/%d/%Y ')
      fromdate = date(now.year,now.month,now.day)
      todate = date(st_date.year,st_date.month,st_date.day)
      daygenerator = (fromdate + timedelta(x + 1) for x in range((todate - fromdate).days))
      days_from_today=sum(1 for day in daygenerator if day.weekday() > 0)
     ...
     <div id="results-depart">
				...
				<H2 style="margin-top:100px;margin-left:20px;">Chose your seats for Departing</H2>
				<div id="col_legend1" style="margin-left:20px;">
						<div id="col1">
							<p id="spacing_last">Legend</p>
						</div>
      ...
      while row60 is not None:
       ...
       <H2 style="margin-top:100px;margin-left:20px;">Chose your seats for Returning</H2>
				<div id="col_legend1" style="margin-left:20px;">
						<div id="col1">
							<p id="spacing_last">Legend</p>
						</div>
