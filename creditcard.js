  ...
  var Validation = (function() {
    ...
    var ValidationErrorHolder = (function() {
      ...
      var triggerErrorMessage = function() {
        ...
        if (window.jQuery) {
          window.jQuery("body").trigger("creditcard_client_validation_error", errorsPayload);
        } else {
          var ev = document.createEvent("MessageEvent");
          ev.initMessageEvent("creditcard_client_validation_error", true, true, errorsPayload, "", "", "", null);
